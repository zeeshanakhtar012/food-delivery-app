// superAdminRoutes.js (renamed from adminRoutes.js, with updates for new functions)
...
router.post('/restaurants/:id/status', toggleRestaurantStatus); // NEW
router.delete('/restaurants/:id', deleteRestaurant); // NEW
