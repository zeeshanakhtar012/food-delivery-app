...
export const restaurantAdmin = {
    ...
    deleteAllFoods: () => api.delete('/api/admin/foods/all'),
    ...
    getPendingLoginRequests: () => api.get('/api/admin/requests/pending'),
    ...
    deleteAllCategories: () => api.delete('/api/admin/categories/all'),
